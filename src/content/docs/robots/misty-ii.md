...
Welcome! Your Misty II robot has been designed and built by the Misty Robotics team. Start here for a quick guide to setting up your robot.
...
You send REST commands to Misty and install skills on her system over your local Wi-Fi connection. Now that you've turned on your robot, you can set up Misty's internet connection with the [Misty App](../../apps/misty-app/#connecting-misty-to-bluetooth-and-wi-fi).
